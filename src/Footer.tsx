...
<ul className=" flex gap-2 justify-around  w-full p-4">
        ...
        <li><a rel="noopener" target="_blank" href="https://github.com/SeraphF2P"><FaGithub className=" hover:text-red-800" /><span className=" v_hidden">gmail link icon</span></a></li>
